<template>
    <div>
        ...
        <form id="user-form" autocomplete="off" @submit="page === 'register' ? register($event) : update($event)">
            ...
            <div class="input-container">
                ...
                <input type="email" autocomplete="off" id="email" name="email" v-model="email"  placeholder="Digite o seu e-mail">
            </div>
            <div class="input-container">
                <label for="password">Senha:</label>
                <input type="password" autocomplete="off" id="password" name="password" v-model="password"  placeholder="Digite sua senha">
            </div>
            <div class="input-container">
